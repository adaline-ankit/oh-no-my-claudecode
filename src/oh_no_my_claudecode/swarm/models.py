...
class SwarmUnit:
    ...
    protected_paths:
        ...
        ``fnmatch``-style patterns; empty list (default) disables the check.
    dependencies:
        Unit ids that must complete with receipt-backed evidence before this
        unit may start. Empty by default for backward-compatible flat swarms.
    """
...
class SwarmResult:
    ...
    unit_results:
        Results for all units, in deterministic source order.
    total_cost_usd:
