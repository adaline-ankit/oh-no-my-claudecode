...
- Publication-grade benchmark scaffolding: strict manifest validation, deterministic
  report and raw-artifact indexes, a fail-closed external claim CLI, an honest
  reproduction guide, and a built-wheel offline fixture smoke in the release gate.
  The committed report is explicitly not publication-ready and makes no SOTA claim.
